				...
				<div class="main_menu_w1230">
					<div>
						<a href="http://localhost:8808/topp/" id="headerLogo"> <img
							src="/top/resources/images/toppingLogo.png">
						</a>
					</div>
					<div class="middle_area">
						...
						<ul class="menubar" id="menubar">
							...
							<li><a class="menuLink" href="views/trip/diaryListView.jsp">여행일기</a></li>
						...
						<div>
							<a href="http://localhost:8808/topp/" id="serviceLogo"> <img
								src="/top/resources/images/toppingService.png">
							</a>
						</div>

						<div>
							<a href="http://localhost:8808/topp/" id="loginLogo"> <img
								src="/top/resources/images/toppingLogin.png">
							</a>
						</div>
					</div>
				</div>
